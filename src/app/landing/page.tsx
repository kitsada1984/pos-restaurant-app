      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-[#0F172A] via-[#2563EB] to-[#14B8A6] flex items-center justify-center text-white shadow-md shadow-blue-500/20 group-hover:scale-105 transition-transform">
              <Store className="w-6 h-6" />
            </div>
            <div>
              <span className="font-extrabold text-xl tracking-tight text-[#0F172A] block leading-none">
          ...
          <div className="flex items-center space-x-3">
            <Link
              href="/pos"
              className="hidden sm:inline-flex px-4 py-2.5 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-100 transition-colors"
            >
              เข้าสู่ระบบ POS
            </Link>
            <Link
              href="/table/1"
              target="_blank"
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#2563EB] to-[#14B8A6] hover:from-blue-700 hover:to-teal-600 text-white text-sm font-bold shadow-lg shadow-blue-500/25 active:scale-95 transition-all flex items-center space-x-1.5"
            >
              <span>ทดลองสั่งที่โต๊ะ</span>
