...
VALUES ('usr-superadmin', 'admin@ordeopos.com', '$2b$10$5zSrGonSanEJ7d3yj5xN5.jwyN7orTlSR7N19uzz7ZgFCTlzNWKUe', 'Super Administrator', 'SUPER_ADMIN', NOW())
...
VALUES ('usr-owner-lungpa', 'owner@lungpa.com', '$2b$10$LYEyFvSOfkScOGHw1Y5f8ezAofzDTXX8Tb.1/CsbCpNvn5zW.e9WW', 'ลุงสมชาย ใจดี', 'STORE_OWNER', 'store-lung-pa', '089-123-4567', NOW())
ON CONFLICT ("email") DO NOTHING;
